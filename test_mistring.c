...
void test_mi_strcpy()
{
    ...
    DebeSerCierto(cadena1 == resultado);
    DebeSerCierto(mi_strlen(cadena1)==6);
...
void test_mi_strdup()
{
    char* cadena1 = "En un lugar";
    char* resultado = mi_strdup(cadena1);
    INICIO_TEST("mi_strdup");
    DebeSerFalso(cadena1 == resultado);
    DebeSerCierto(mi_strlen(cadena1)==11);
    DebeSerCierto(mi_strequals(cadena1, resultado));
    DebeSerCierto(mi_strequals(resultado, "En un lugar"));
    DebeSerFalso(mi_strequals(cadena1,"hola"));
    FIN_TEST("mi_strdup");
}
